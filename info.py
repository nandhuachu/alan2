...
URL = "https://moviiwrld.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviiwrld.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviiwrld.onrender.com/".format(FQDN)
else:
    URL = "https://moviiwrld.onrender.com/".format(FQDN)
