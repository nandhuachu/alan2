...
URL = "https://daemon-otim.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://daemon-otim.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://daemon-otim.onrender.com/".format(FQDN)
else:
    URL = "https://daemon-otim.onrender.com/".format(FQDN)
