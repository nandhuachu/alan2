...
URL = "https://rendee-d2b8da759b35.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://rendee-d2b8da759b35.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://rendee-d2b8da759b35.herokuapp.com/".format(FQDN)
else:
    URL = "https://rendee-d2b8da759b35.herokuapp.com/".format(FQDN)
