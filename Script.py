...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},I ᴀᴍ ᴘᴏᴡᴇʀ ғᴜʟʟ Movie Search Bot And Advanced Online Watching and Fast Download BOT But No Theatre Prints Available in MY DB So Dont Search Theatre Prints 🤷‍♂️ 
 
 
𝐌𝐚𝐢𝐧𝐭𝐚𝐢𝐧𝐞𝐝 𝐁𝐲 : @MoviiWrld</b>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>⍟───[ MY ᴅᴇᴛᴀɪʟꜱ ]───⍟
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/MW_MoViE_bot>MoviiWrld 🇮🇳</a>
 ‣ My best friend : <a href='tg://settings'>ᴛʜɪs ᴘᴇʀsᴏɴ</a> 
 ‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/MoviiWrld'>MoviiWrld</a> 
...
Where is source code? - <a href='https://t.me/MoviiWrld'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>


Developer - <a href='https://t.me/MoviiWrld'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/MoviiWrld>MoviiWrld</a></b>
  
 <b>✯ Join here : <a href=https://t.me/MoviiWrld>☢Join my updateds☢</a></b> 
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த MW_MoViE_BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this MW_MoViE_BOT bot to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ MW_MoViE_BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस MW_MoViE_BOT बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ MW_MoViE_BOT ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس MW_MoViE_BOT بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ MW_MoViE_BOT બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ MW_MoViE_BOT ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই MW_MoViE_BOT বট পরিচালনা করুন
...
-OWNER [Owner of this bot ]<a href='https://t.me/MoviiWrld'>MoviiWrld</a>"""
